...
if (getInfo($_SESSION['user']['pseudo'])['bois']>=200) :
    $sql ="UPDATE users SET bois=bois-'200' WHERE pseudo='test'";
...
if (isset($_POST['VenteNourriture'])){
    VenteNourriture();
}

function VenteNourriture(){

global $mysqli;
// lancement de la requête
if (getInfo($_SESSION['user']['pseudo'])['nourriture']>=200) :
...
if (isset($_POST['VentePierre'])){
    VentePierre();
}

function VentePierre(){

global $mysqli;
// lancement de la requête
if (getInfo($_SESSION['user']['pseudo'])['pierre']>=200) :
    $sql ="UPDATE users SET pierre=pierre-'200' WHERE pseudo='test'";
    mysqli_query($mysqli ,$sql);
    $sql ="UPDATE users SET gold=gold+'20' WHERE pseudo='test'";
    mysqli_query($mysqli ,$sql);
endif;
...
global $mysqli;
// lancement de la requête
if (getInfo($_SESSION['user']['pseudo'])['fer']>=100) :
    ...
    <li>
        <ul class="market">
            <li>
                ...
                <p>vendre 200 de bois</p>
                <p>contre 20 d'or</p>
                <ul class="Submit">
                    <form action="" method="post" class="form">
                    <button value="valider" class="button" type="submit" name="VenteBois">vendre</button>  
                </ul>    
            </li>
        </ul>
    </li>
    <li>
        <ul class="market">
            <li>
                ...
                <p>vendre 200 de pierre</p>
                <p>contre 20 d'or</p>
                <ul class="Submit">
                    <form action="" method="post" class="form">
                    <button value="valider" class="button" type="submit" name="VentePierre">vendre</button>  
                </ul>    
            </li>
        </ul>
    </li>
    ...
    <li>
        <ul class="market">
            <li>
                ...
                <p>vendre 200 de nouriture</p>
                <p>contre 20 d'or</p>
                <ul class="Submit">
                    <form action="" method="post" class="form">
                    <button value="valider" class="button" type="submit" name="VenteNourriture">vendre</button>  
                </ul>    
            </li>
        </ul>
    </li>
    <li>
        <ul class="market">
            <li>
                ...
                <p>vendre 100 de fer</p>
                <p>contre 50 d'or</p>
                <ul class="Submit">
                    <form action="" method="post" class="form">
                    <button value="valider" class="button" type="submit" name="VenteFer">vendre</button>  
                </ul>    
            </li>
        </ul>
    </li>
