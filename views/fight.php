...
<img src="https://media.contentapi.ea.com/content/dam/gin/images/2017/01/lotr-the-battle-for-middle-earth-keyart-min.jpg.adapt.crop16x9.575p.jpg" alt="Image" height="90%" width="92%">
<?php if ($min == 3 and $sec == 0 or $min == 3 and $sec == 1 or $min == 3 and $sec == 2) :?>
                <?php if($nbr==1) : ?>
                    <li>
                    <a href=<?php uri('défaite'); ?>><BLOCKQUOTE><BLOCKQUOTE><BLOCKQUOTE><BLOCKQUOTE><BLOCKQUOTE>Combat</a>
                    </li>
                <?php elseif($nbr==2): ?>
                    <li>
                    <a href=<?php uri('victoire'); ?>><BLOCKQUOTE><BLOCKQUOTE><BLOCKQUOTE><BLOCKQUOTE><BLOCKQUOTE>Combat</a>
                    </li>
                <?php endif; ?>
<?php endif; ?>
</ul>                
