...
<img src="https://i.ytimg.com/vi/Q8usnUdLlvI/maxresdefault.jpg" alt="Image" height="90%" width="92%">

<a href=<?php uri('HomeIG'); ?>><BLOCKQUOTE><BLOCKQUOTE><BLOCKQUOTE><BLOCKQUOTE><BLOCKQUOTE>Victoire</a>
</ul>                
</div>

<?php
if ($min == 3 and $sec == 0 or $min == 3 and $sec == 1 or $min == 3 and $sec == 2 or $min == 3 and $sec == 3or $min == 3 and $sec == 4) :
global $mysqli;
// lancement de la requête
$sql ="UPDATE users SET gold=gold+'1'*frondeur+'3'*lancier+'5'*chevalier+'10'*cavalier+'25'*belier+'50'*catapulte WHERE pseudo='test'";
$result = mysqli_query($mysqli ,$sql);
endif;